"""Write auditoria PowerShell script — NO backticks at all."""
import os

target = r"C:\Users\JorgeHaraDevs\Desktop\Dev\jorgehara\Alquileres-La-Casona\scripts\auditoria.ps1"

lines = [
'#Requires -Version 5.1',
'$ErrorActionPreference = "SilentlyContinue"',
'',
'$outputDir = "C:\\auditoria-alquileres"',
'if (!(Test-Path $outputDir)) { New-Item -ItemType Directory -Path $outputDir -Force | Out-Null }',
'',
'$ts = Get-Date -Format "yyyy-MM-dd HH:mm:ss"',
'$md = @()',
'',
'function Section($t) { $md += ""; $md += "## $t"; $md += "" }',
'function Line($t)   { $md += $t }',
'function Code($t)   { $md += $t }',
'function KV($k, $v) { $md += "- **" + $k + "**: " + $v }',
'',
